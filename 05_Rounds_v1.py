...
print(f"The computer rolled a total of {computer_first}.")
...
while computer_points <= 13 and user_points <= 13:
    ...
    print(f"The computer rolled a {computer_move}.  The computer" f"now has {computer_points}.")
...
# Show rounds result
if user_points < computer_points:
    print("Sorry - you lost this round and no points have been added to your total score. The computer's score had "f"increased by {computer_points} points.")

# currently does not include double points!
else:
    print(f"Yay! You won the round and {user_points} points have "f"been added to your score")
